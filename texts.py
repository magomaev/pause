...
ONBOARDING_NO_REMINDERS = """Хорошо, напоминания отключены.

Их можно включить позже — или не использовать вовсе.

А здесь всегда можно замедлиться, взять паузу и побыть в ней столько, сколько нужно."""
